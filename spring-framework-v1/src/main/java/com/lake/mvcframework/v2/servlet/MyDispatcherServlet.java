package com.lake.mvcframework.v2.servlet;
...
public class MyDispatcherServlet extends HttpServlet {
    ...
    private void doDispatch(HttpServletRequest req, HttpServletResponse resp) throws IOException, InvocationTargetException, IllegalAccessException {
        ...
        //获取的method所属的类的 name投机取巧的方式
        String beanName = toLowerFirstCase(method.getDeclaringClass().getSimpleName());
        //获取请求参数
        Object[] params = paramAdapter(method, req, resp);

        //从IOC中根据bean name获取method所属的类对象
        Object value = method.invoke(ioc.get(beanName), params);
     ...
     * @return
     */
    private Object[] paramAdapter(Method method, HttpServletRequest req, HttpServletResponse resp) {
            ...
            if (parameter.getType() == HttpServletRequest.class) {
                ...
                if (parameterMap.containsKey(paramName)) {
                    for (String value : parameterMap.get(paramName)) {
                        if (parameter.getType() == Integer.class || int.class == parameter.getType()) {
                            paramValue.add(Integer.valueOf(value));
                        } else {
        ...
        log.debug("method[{}] invoke with parameter[{}]", method.getName(), paramValue);
